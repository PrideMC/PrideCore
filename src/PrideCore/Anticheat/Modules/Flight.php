				...
				if($player->getInAirTicks() > 40){
					$maxY = $player->getWorld()->getHighestBlockAt($newPos->getX(), $newPos->getZ());
						if($newPos->getY() - 2 > $maxY){
							...
							or !in_array(BlockTypeIds::COBBLESTONE_WALL, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::ACACIA_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::OAK_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::BIRCH_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::DARK_OAK_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::JUNGLE_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::NETHER_BRICK_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::SPRUCE_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::WARPED_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::MANGROVE_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::CRIMSON_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::CHERRY_FENCE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::ACACIA_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::OAK_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::BIRCH_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::DARK_OAK_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::JUNGLE_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::SPRUCE_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::WARPED_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::MANGROVE_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::CRIMSON_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::CHERRY_FENCE_GATE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::GLASS_PANE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::HARDENED_GLASS_PANE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::STAINED_GLASS_PANE, $surroundingBlocks, true)
							or !in_array(BlockTypeIds::STAINED_HARDENED_GLASS_PANE, $surroundingBlocks, true)
							){
								$this->fail($player);
							}
						}
