 ...
 * Cosmetic UI
 */
class CosmeticsCommand extends Command implements PluginOwned
{
	...
	public function __construct(){
		parent::__construct("cosmetics", "Cosmetics Menu", "/cosmetics");
		$this->setPermission("pride.staff.cosmetics");
	}
